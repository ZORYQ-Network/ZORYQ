...
server.listen(PORT,'0.0.0.0',()=>console.log(`[zoryq-product] gateway listening on :${PORT}; chain=:${CHAIN_PORT}; social=:${SOCIAL_PORT}; release=infra-v2-memory-aware`));
