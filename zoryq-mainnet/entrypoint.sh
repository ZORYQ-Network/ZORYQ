...
: "${ZORYQ_MAINNET_REDUNDANCY_EVIDENCE_PATH:?ZORYQ_MAINNET_REDUNDANCY_EVIDENCE_PATH is required}"
...
required_files=(
  ...
  "$ZORYQ_MAINNET_REDUNDANCY_EVIDENCE_PATH"
...
require_manifest_hash recoveryEvidenceSha256 "$ZORYQ_MAINNET_RECOVERY_EVIDENCE_PATH" 'recovery evidence'
require_manifest_hash redundancyEvidenceSha256 "$ZORYQ_MAINNET_REDUNDANCY_EVIDENCE_PATH" 'network redundancy evidence'
